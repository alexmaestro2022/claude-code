...
def _get_commands() -> list[dict]:
    ...
    defaults = [
        ...
        {"id": "status", "name": "ℹ️ Быстрый статус", "icon": "fa-circle-info", "category": "monitoring",
        ...
        {"id": "config", "name": "⚙️ Настройки", "icon": "fa-gear", "category": "management",
        ...
        {"id": "autopilot_pause", "name": "⏸️ Пауза", "icon": "fa-pause", "category": "management",
